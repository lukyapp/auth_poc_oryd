import { type UiNode, type UiNodeTextAttributes, type UiText } from '@ory/client';
...
const Content = ({ node, attributes }: Props) => {
  ...
  return (
    <div className="w-full p-4 rounded-md border flex-wrap text-sm">{attributes.text.text}</div>
  );
};
