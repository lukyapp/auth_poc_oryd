...
import { isUiNodeInputAttributes, isUiNodeScriptAttributes, type UiNode } from '@ory/client-fetch';
...
export const findNode = <T extends UiNodeAttributes['node_type']>(
  ...
  nodes.find((n) => {
    return (
      ...
      (opt.group instanceof RegExp ? n.group.match(opt.group) : n.group === opt.group) &&
  ...
  }) as (UiNode & { attributes: UiNodeAttributes & { node_type: T } }) | undefined;
