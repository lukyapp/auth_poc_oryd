...
const ComponentProvider = ({ children, components }: PropsWithChildren<ComponentOverrider>) => (
  <OryComponentProvider components={getOryComponents(components)}>{children}</OryComponentProvider>
);

export const renderWithComponents = (
  ui: ReactElement,
  options?: Omit<RenderOptions, 'wrapper'> & ComponentProps<typeof ComponentProvider>,
