...
import { messageTestId, type OryNodeInputProps, uiTextToFormattedMessage } from '@infra/ory';
...
export const DefaultCheckbox = ({ attributes: initialAttributes, node }: OryNodeInputProps) => {
